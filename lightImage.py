        ...
        for s in range(0,self.nbStep):
            ...
            for x in range(self.width):
                for y in range(self.lightBarLength):
                    ...
                    if(s%2 is 0):
#                        print "normal print"
                        value = self.pixels[x, y + s*self.lightBarLength]
                    else:
#                        print "reverse print"
                        value = self.pixels[self.width - x - 1, y + s*self.lightBarLength]
                    y3 = (y)* 3
                    #print "%d,%d,%d"%(x,y,y3)
...
if __name__ == "__main__":
    i1= lightImage("png/joconde64.png",32,"rouleau")
#    i1= lightImage("png/joconde.png",32,"rouleau")
#    i1.paint_step()
